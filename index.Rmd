...
## Un exemple sur l'utilisation de ```apply()``` pour TP4 et TP5

Ici, je vous donne un exemple de l'utilisation de
```apply()``` en respectant les exos de TP4 et TP5
...
qqch sur cette histoire. Dans le problème de anorexie, 
il y a vers 30 données
...
En suite, on tire un échantillon de taille 30 parmi les
1000 observations qu'on a simulé.
